;******************************************************************
;* Program Description:                                           *
;* This program initializes an LCD, displays a string,            *
;* and converts hex values to ASCII for display.                  *
;* It runs in a loop, clearing the display and introducing        *
;* a 1-second delay between iterations.                           *
;*                                                                *
...
;* Program starts here                                            *
;******************************************************************
MainLoop    JSR   clrLCD            ; clear LCD and home cursor

            LDX   #msg1               ; display msg1
            JSR   putsLCD           ;    -"-
            
            LDAA  HEX_ONE           ; load contents at $3000 into A
            ...
            LDAA  HEX_TWO           ; load contents at $3001 into A
            JSR   leftHLF           ; convert left half of A into ASCII
...
;******************************************************************
;* This function outputs the characer in accumulator in A to LCD  *
;******************************************************************                                                        
