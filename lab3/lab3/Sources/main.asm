;****************************************************************
;* This program works to display the current battery voltage and
;* bumper switch states of the EEBOT   
;* Author: Rayyan Faisal, 501196760  
;****************************************************************
...
LCD_E       EQU $80                         ;LCD enable signal, pin PJ7
LCD_RS      EQU $40                         ;LCD register select, pin PJ6
